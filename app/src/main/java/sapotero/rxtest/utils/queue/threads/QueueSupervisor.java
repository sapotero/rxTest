...
public class QueueSupervisor implements JobCountInterface {
  ...
  private void start() {
    ...
    commandPool = new ThreadPoolExecutor(THREAD_POOL_SIZE, THREAD_POOL_SIZE*2, 60, TimeUnit.SECONDS, new ArrayBlockingQueue<>(THREAD_POOL_SIZE), threadFactory, rejectionHandler);
