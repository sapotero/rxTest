...
public class NotifiManager {
    ...
    private final int THRESHOLD_VALUE = 5; /*величина больше которой, уведомления группируем*/


    public NotifiManager(List<String> addedDocList, HashMap<String, Document> documentsMap, String index, String filter) {
