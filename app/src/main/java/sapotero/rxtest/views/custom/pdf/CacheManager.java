...
import static sapotero.rxtest.views.custom.pdf.util.Constants.Cache.CACHE_SIZE;
import static sapotero.rxtest.views.custom.pdf.util.Constants.Cache.THUMBNAILS_CACHE_SIZE;
