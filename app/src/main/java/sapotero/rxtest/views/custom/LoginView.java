...
import sapotero.rxtest.views.custom.utils.Animations;
import sapotero.rxtest.views.custom.utils.VerticalStepperForm;
...
public class LoginView extends RelativeLayout implements View.OnClickListener {
  ...
  protected void setUpStepLayoutAsConfirmationStepLayout(LinearLayout stepLayout) {
    ...
    verticalStepperFormImplementation.setFinalView( stepContent );
  }
