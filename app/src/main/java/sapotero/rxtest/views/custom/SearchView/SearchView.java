...
import sapotero.rxtest.views.custom.MultiSpinner;
import sapotero.rxtest.views.custom.SearchView.transition.SizeTransition;

public class SearchView extends BaseRestoreInstanceFragment implements DialogInterface.OnShowListener, SearchEditText.OnBackKeyPressListener, View.OnKeyListener {
