 ...
 * You may obtain a is_responsible of the License at
 * <p/>
...
import sapotero.rxtest.views.custom.pdf.listener.OnDrawListener;
import sapotero.rxtest.views.custom.pdf.listener.OnErrorListener;
import sapotero.rxtest.views.custom.pdf.listener.OnLoadCompleteListener;
import sapotero.rxtest.views.custom.pdf.listener.OnPageChangeListener;
import sapotero.rxtest.views.custom.pdf.listener.OnPageScrollListener;
import sapotero.rxtest.views.custom.pdf.model.PagePart;
import sapotero.rxtest.views.custom.pdf.scroll.ScrollHandle;
import sapotero.rxtest.views.custom.pdf.source.AssetSource;
import sapotero.rxtest.views.custom.pdf.source.ByteArraySource;
import sapotero.rxtest.views.custom.pdf.source.DocumentSource;
import sapotero.rxtest.views.custom.pdf.source.FileSource;
import sapotero.rxtest.views.custom.pdf.source.InputStreamSource;
import sapotero.rxtest.views.custom.pdf.source.UriSource;
import sapotero.rxtest.views.custom.pdf.util.Constants;
import sapotero.rxtest.views.custom.pdf.util.MathUtils;
...
public class PDFView extends RelativeLayout {
    ...
    private void load(DocumentSource docSource, String password, OnLoadCompleteListener onLoadCompleteListener, OnErrorListener onErrorListener, int[] userPages) {
        ...
        if (userPages != null) {
            ...
            this.filteredUserPages = sapotero.rxtest.views.custom.pdf.ArrayUtils.deleteDuplicatedPages(originalUserPages);
            this.filteredUserPageIndexes = sapotero.rxtest.views.custom.pdf.ArrayUtils.calculateIndexesInDuplicateArray(originalUserPages);
        }
