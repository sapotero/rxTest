...
public abstract class BaseRestoreInstanceFragment extends DialogFragment {

    private static final String REQUEST_CLOSE_INSTANCE = "sapotero.rxtest.views.custom.SearchView.BaseRestoreInstanceFragment.flag.closeRequested";
    private static final String VISIBILITY_INSTANCE = "sapotero.rxtest.views.custom.SearchView.BaseRestoreInstanceFragment.flag.visible";
    private static final String QUERY_INSTANCE = "sapotero.rxtest.views.custom.SearchView.BaseRestoreInstanceFragment.text.query";
    private static final String HINT_INSTANCE = "sapotero.rxtest.views.custom.SearchView.BaseRestoreInstanceFragment.text.hint";
    private static final String CURSOR_POSITION_INSTANCE = "sapotero.rxtest.views.custom.SearchView.BaseRestoreInstanceFragment.position.cursor";
    private static final String TYPEFACE_INSTANCE = "sapotero.rxtest.views.custom.SearchView.BaseRestoreInstanceFragment.typeface.value";
    private static final long ANIMATOR_DURATION_SHOW = 300L;
    protected static final String DIALOG_TAG = "sapotero.rxtest.views.custom.SearchView.BaseRestoreInstanceFragment.tag";
    ...
    protected final View.OnClickListener mCloseVoiceClickListener = v -> onCloseVoiceClicked();

    protected void onNavigationBackClicked() {
    }

    protected final View.OnClickListener mNavigationBackClickListener = v -> onNavigationBackClicked();

    protected void onOutsideTouch(View v, MotionEvent event) {
    }

    protected final View.OnTouchListener mOnOutsideTouchListener = (v, event) -> {
    ...
    void hideKeyboard() {
        ((InputMethodManager) getActivity().getSystemService(Context.INPUT_METHOD_SERVICE)).toggleSoftInput(InputMethodManager.HIDE_IMPLICIT_ONLY, 0);
    }
}
