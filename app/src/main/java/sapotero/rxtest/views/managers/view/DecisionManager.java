package sapotero.rxtest.views.managers.view;
...
import sapotero.rxtest.views.managers.view.builders.DecisionBuilder;
import sapotero.rxtest.views.managers.view.builders.PreviewBuilder;
...
public class DecisionManager implements DecisionInterface, DecisionBuilder.Callback, PreviewBuilder.Callback {
  ...
  public void saveDecision(){
    ...
    Preference<String> uid = rxPreferences.getString("info.uid");
