...
public class Fields {
  ...
  public enum Journal {
    ...
    SECRET_INCOMING_DOCUMENTS ( "06", "Входящий секретный",    "Вам поступил "),
    SECRET_INCOMING_ORDERS    ( "07", "НПА секретный",         "Вам поступил "),
    SECRET_ORDERS             ( "08", "Пр. старый секретный",  "Вам поступил "),
    SECRET_OUTGOING_DOCUMENTS ( "09", "Исходящий секретный",   "Вам поступил "),
    ORDERS_DDO                ( "10", "Приказ",                "Вам поступил "),
    CONTROL                   ( "97", " ",                     "Вам поступил "),
